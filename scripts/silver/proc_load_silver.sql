...
-- ===============================================================================
-- Script Purpose:
--     This procedure loads data into the 'Silver' schema from 'Bronze' Schema.
-- 	   Steps
-- 	   	 - Truncate silver table before loading
-- 		 - Perform data transformation
-- 			- check for nulls, unwanted spaces
...
BEGIN
	BEGIN
		...
		RAISE NOTICE '>>silver.crm_cust_info Load Duration: % seconds', EXTRACT(epoch FROM end_time - start_time);
		...
		end_time := clock_timestamp(); 
		RAISE NOTICE '>>silver.crm_prd_info Load Duration: % seconds', EXTRACT(epoch FROM end_time - start_time);
		...
		end_time := clock_timestamp(); 
		RAISE NOTICE '>>silver.crm_sales_details Load Duration: % seconds', EXTRACT(epoch FROM end_time - start_time);
